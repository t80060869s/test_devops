# Мониторинг процессов в Linux через systemd + bash
...
# Нажмите ENTER, чтобы завершить процесс и запустите снова — в /var/log/monitoring.log появится запись о перезапуске
./test
```
